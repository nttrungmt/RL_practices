...
if(ENVIRONMENT_NAME == 'CartPole-v0'):
...
elif(ENVIRONMENT_NAME == 'MountainCarContinuous-v0'):
    ...
    NUMBER_OF_EXPLORATION_EPISODES = 100
    INITIAL_STANDARD_DEVIATION = 5.
elif(ENVIRONMENT_NAME == 'LunarLanderContinuous-v2'):
    #Parameters that work well for LunarLanderContinuous-v2
    ...
    ORNSTEIN_UHLENBECK_NOISE_SCALE = 5
    INITIAL_ORNSTEIN_UHLENBECK_NOISE_RATIO = 1.
    NUMBER_OF_EXPLORATION_EPISODES = 0.5*MAX_EPISODES
